...
Clean Architecture + SwiftUI Coordinator Pattern 기반 개인 가계부 iOS 앱

<div align="center">

![MoneyMoa 메인 화면](images/card_1_당신의_소비를_데이터로_관리하세요.png)

**한눈에, 스마트하게, 계획적인 재정관리 시작**
...
MoneyMoa는 Clean Architecture와 현대적 iOS 개발 기법을 실무에 적용한 개인 가계부 앱입니다. 복잡한 기존 가계부 앱들의 문제를 해결하고자 간단함과 직관성에 집중하여 개발된 실용적인 학습 프로젝트입니다.

### SwiftUI, SwiftData, Modern iOS Development 실전 프로젝트
...
이번 달 사용 금액, 남은 예산, 목표까지 직관적으로 보여줍니다

![예산 대시보드](images/card_2_예산과_소비_한눈에_확인.png)
...
식비, 교통비, 문화생활 등 항목별로 예산을 나누어 계획적인 소비

![카테고리별 예산](images/card_3_카테고리별_예산으로_더_정밀하게_관리하세요.png)
...
넷플릭스, 스포티파이 등 정기 결제를 자동으로 관리

![반복 거래](images/card_4_매달_자동_등록되는_구독비_놓치지_마세요.png)
...
결제수단별 비율, 요일별 지출 그래프, 주요 카테고리 순위까지

![소비 패턴 분석](images/card_5_한눈에_보는_소비_패턴.png)
...
![거래 내역 캘린더](images/card_6_날짜별_소비_흐름을_한눈에.png)

### 📊 지금 바로 계획적인 소비를 시작하세요

![통계 차트](images/card_7_지금_바로_계획적인_소비를_시작하세요.png)
